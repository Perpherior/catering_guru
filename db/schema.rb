...
ActiveRecord::Schema.define(version: 20150410051209) do
  ...
  add_index "slideshows", ["article_id"], name: "index_slideshows_on_article_id", using: :btree
  ...
  add_foreign_key "slideshows", "articles"
end
